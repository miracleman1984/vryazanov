...
class Book {
    ...
    Book(String name) {
        this.name = name;
        this.buy = new HashMap<String, Order>();
        this.buyPrice = new TreeSet<Order>(new Comparator<Order>() {
            @Override
            public int compare(Order o1, Order o2) {
                return Double.compare(o2.getPrice(), o1.getPrice());
            }
        });
        this.sell = new HashMap<String, Order>();
        this.sellPrice = new TreeSet<Order>(new Comparator<Order>() {
            @Override
            public int compare(Order o1, Order o2) {
